        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <YouTubeEmbed
                videoId="NIIfzpNR1x4"
                title="Teleport Platform Demo - Advanced Remote Access Solutions"
      ...
      <section className="py-24 bg-gradient-to-br from-brand-accent-light to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-brand-charcoal max-w-3xl mx-auto">
              Advanced remote access and connectivity solutions
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-8 border border-slate-200/50">
              <img 
                src="/brochures/teleport-preview.jpg" 
                alt="Teleport Platform Brochure"
              ...
              <div className="mt-6 text-center">
                <Button 
                  onClick={() => {
                    ...
                    link.href = '/brochures/teleport-preview.jpg';
                    link.download = 'Teleport-Platform-Brochure.jpg';
                    link.click();
                  }}
      ...
      <section className="py-24 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-manrope font-bold text-4xl lg:text-5xl mb-6">
            Ready to Transform Remote Access?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Join organizations leveraging Teleport for secure remote connectivity
          </p>
